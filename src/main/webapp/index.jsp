    ...
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                <button class="mobile-toggle" id="mobileToggle" aria-label="Open menu"><em> class="fas fa-bars"></i></button>
                <a class="brand" href="#">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Primary navigation">
                <ul>
                    ...
                    <li class="has-dropdown" aria-haspopup="true">
                        <a href="#" id="catMenuBtn"><em> class="fas fa-th-large"></i> Categories <em> class="fas fa-chevron-down" style="font-size:12px;"></i></a>
                    </li>
                    <li><a href="#"><em> class="fas fa-fire"></i> Trending</a></li>
                    <li><a href="#deals"><em> class="fas fa-tag"></i> Deals</a></li>
                    <li><a href="#about"><em> class="fas fa-info-circle"></i> About</a></li>
                </ul>
            </nav>

            <div style="display:flex;align-items:center;gap:14px;">
                <div class="search" role="search" aria-label="Product search">
                    <em>nput type="search" id="searchInput" placeholder="Search products, categories..." aria-label="Search products" />
                    <button class="icon-btn" id="searchBtn" aria-label="Search"><em> class="fas fa-search"></i></button>
                </div>

                <div class="header-actions" role="group" aria-label="Header actions">
                    <a class="icon-btn" title="Account" href="#"><em> class="far fa-user"></i></a>
                    <a class="icon-btn" title="Wishlist" href="#"><em> class="far fa-heart"></i></a>
                    <a class="cart" href="#" id="cartBtn" title="View cart" aria-label="Cart">
                        <em> class="fas fa-shopping-cart"></i>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                ...
                <div>
                    <button class="btn btn-primary" id="shopNow">Shop Now <em> class="fas fa-arrow-right"></i></button>
        ...
        <section id="deals" class="section container" aria-labelledby="deals-title">
            ...
            <div class="deal" style="align-items:stretch;">
                <em>mg src="https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=1200&q=80" alt="Deal product">
                <div class="content">
            ...
            <div class="testimonials" id="testimonials">
                <div class="testimonial">
                    ...
                    <div style="display:flex;align-items:center;gap:10px">
                        <em>mg src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=80&q=80" alt="avatar" style="width:40px;height:40px;border-radius:50%;object-fit:cover">
                        <div>
                ...
                <div class="testimonial">
                    ...
                    <div style="display:flex;align-items:center;gap:10px">
                        <em>mg src="https://images.unsplash.com/photo-1546456073-6712f79251bb?auto=format&fit=crop&w=80&q=80" alt="avatar" style="width:40px;height:40px;border-radius:50%;object-fit:cover">
                        <div>
        ...
        <section class="section container" aria-labelledby="news-title">
            <div class="newsletter" id="newsletter">
                ...
                <form id="newsletterForm" style="display:flex;justify-content:center;gap:8px;flex-wrap:wrap;" onsubmit="return false;">
                    <em>nput id="newsletterEmail" type="email" placeholder="Enter your email" aria-label="Email address" required>
        ...
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                ...
                <div style="margin-top:14px;display:flex;gap:10px">
                    <a class="icon-btn" href="#" title="Facebook"><em> class="fab fa-facebook"></i></a>
                    <a class="icon-btn" href="#" title="Twitter"><em> class="fab fa-twitter"></i></a>
                    <a class="icon-btn" href="#" title="Instagram"><em> class="fab fa-instagram"></i></a>
                </div>
            </div>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon"><em> class="fas ${cat.icon}"></i></div>
                    <h4>${cat.name}</h4>
        ...
        function renderProducts(list) {
            ...
            list.forEach(p => {
                ...
                el.innerHTML = `
                    ...
                    <em>mg src="${p.img}" alt="${escapeHtml(p.title)}">
                    ...
                    <div class="product-footer">
                        <button class="add-btn" data-id="${p.id}"><em> class="fas fa-cart-plus"></i> Add</button>
                        <button class="wish-btn" aria-label="Add to wishlist"><em> class="far fa-heart"></i></button>
                    </div>
                `;
